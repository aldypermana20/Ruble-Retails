...
<head>
    ...
    <title>Delivery Information - Ruble Retails</title>
...
<body class="bg-gray-50 font-sans text-gray-800 antialiased">
    ...
    <div class="container mx-auto px-6 py-12">
        <div class="max-w-4xl mx-auto">
            <h1 class="text-4xl font-bold text-ruble-dark mb-6">Delivery Information</h1>
            <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 prose max-w-none"><p class="text-lg text-gray-600 mb-4">We offer fast and reliable delivery services.</p><p class="text-gray-600">Orders above Rp 100.000 qualify for free delivery.</p></div>
        </div>
    </div>
</body>
</html>
