...
<head>
    ...
    <title>Privacy Policy - Ruble Retails</title>
...
<body class="bg-gray-50 font-sans text-gray-800 antialiased">
    ...
    <div class="container mx-auto px-6 py-12">
        <div class="max-w-4xl mx-auto">
            <h1 class="text-4xl font-bold text-ruble-dark mb-6">Privacy Policy</h1>
            <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 prose max-w-none"><p class="text-lg text-gray-600 mb-4">Your privacy is important to us.</p><p class="text-gray-600">We collect information to provide better services to all our users.</p></div>
        </div>
    </div>
</body>
</html>
